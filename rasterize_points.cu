	...
	const int profile_mask)
{
  ...
  if(P != 0)
  {
	...
	// Copy final_T (accum_alpha) out for analysis.
	...
	return std::make_tuple(rendered, out_color, radii, geomBuffer, binningBuffer, imgBuffer, out_invdepth, final_T_tensor);
}
